                ...
                >
                    <div className="relative mb-4">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            className="w-full dark:bg-gray-800 bg-gray-300 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        />
                        <ValidationError
                            prefix="Name"
                            field="name"
                    ...
                    <div className="relative mb-4">
                        ...
                        <textarea
                            id="message"
                            name="message"
                            className="w-full dark:bg-gray-800 bg-gray-300 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                        />
                        <ValidationError
                            prefix="Message"
                            field="message"
